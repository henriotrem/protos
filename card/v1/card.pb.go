...
var file_card_v1_card_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x63, 0x61, 0x72, 0x64, 0x22, 0x90, 0x01, 0x0a, 0x04, 0x43,
	...
	0x01, 0x28, 0x03, 0x52, 0x08, 0x6d, 0x6f, 0x64, 0x69, 0x66, 0x69, 0x65, 0x64, 0x22, 0x30, 0x0a,
	...
	0x31, 0x0a, 0x0f, 0x41, 0x64, 0x64, 0x43, 0x61, 0x72, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x52, 0x02, 0x69, 0x64, 0x22, 0x31, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x43, 0x61, 0x72, 0x64, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1e, 0x0a, 0x04, 0x63, 0x61, 0x72, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x2e, 0x43, 0x61, 0x72,
	0x64, 0x52, 0x04, 0x63, 0x61, 0x72, 0x64, 0x22, 0x23, 0x0a, 0x11, 0x44, 0x65, 0x6c, 0x65, 0x74,
	...
	,
	...
	0x74, 0x1a, 0x18, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x43,
	0x61, 0x72, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0f, 0x5a, 0x0d, 0x2e,
	0x2f, 0x63, 0x61, 0x72, 0x64, 0x2f, 0x76, 0x31, 0x2f, 0x3b, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_card_v1_card_proto_goTypes = []interface{}{
	...
	(*GetCardRequest)(nil),     // 3: card.GetCardRequest
	(*GetCardResponse)(nil),    // 4: card.GetCardResponse
	(*DeleteCardRequest)(nil),  // 5: card.DeleteCardRequest
	(*DeleteCardResponse)(nil), // 6: card.DeleteCardResponse
}
var file_card_v1_card_proto_depIdxs = []int32{
	0, // 0: card.AddCardRequest.card:type_name -> card.Card
	0, // 1: card.AddCardResponse.card:type_name -> card.Card
	0, // 2: card.GetCardResponse.card:type_name -> card.Card
	1, // 3: card.CardService.AddCard:input_type -> card.AddCardRequest
	3, // 4: card.CardService.GetCard:input_type -> card.GetCardRequest
	5, // 5: card.CardService.DeleteCard:input_type -> card.DeleteCardRequest
	2, // 6: card.CardService.AddCard:output_type -> card.AddCardResponse
	4, // 7: card.CardService.GetCard:output_type -> card.GetCardResponse
	6, // 8: card.CardService.DeleteCard:output_type -> card.DeleteCardResponse
...
func (c *cardServiceClient) AddCard(ctx context.Context, in *AddCardRequest, opts ...grpc.CallOption) (*AddCardResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/card.CardService/AddCard", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CardService_AddCard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/card.CardService/AddCard",
	}
